from . import pipelines, test_sale_order_etl, test_itr_pipeline, test_res_company_etl, test_res_partner_etl_state, test_product_name_search, test_sap_search_mixin
